...
# the main plot
ax.plot(range(50, len(data['train_e_nn'])), data['train_e_nn'][50:], color = 'blue', marker = 'o', label = "СКО, потенциалы")
...
# the main plot
ax.plot(range(50, len(data['train_f_nn'])), data['train_f_nn'][50:], color = 'blue', marker = 'o',label = "СКО, силы на атомах")
